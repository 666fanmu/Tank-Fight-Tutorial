...
public class TankManager
{
    ...
    public void Setup()
    {
        ...
        m_Armor = m_Instance.GetComponent<TankArmor>();
        m_Pick = m_Instance.GetComponent<Picks>();
        m_buff = m_Instance.GetComponent<Buffs>();
        m_CanvasGameObject = m_Instance.GetComponentInChildren<Canvas>().gameObject;
        
        m_Armor.m_PlayerNumber = m_PlayerNumber;
        m_Movement.m_PlayerNumber = m_PlayerNumber;
        m_Shooting.m_PlayerNumber = m_PlayerNumber;
        m_buff.m_PlayerNumber = m_PlayerNumber;
